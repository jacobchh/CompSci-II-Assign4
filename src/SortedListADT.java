...
public interface SortedListADT<T> {
	/**
	 * Adds one CellData object storing the given dataItem and value to the ordered
	 * list. The list must be sorted after the insertion.
	 * 
	...
	/**
	 * Removes the given data item. An InvalidDataItemException is thrown if the
	 * gioven data item is not stored in the sorted list.
	 *
	...
	/**
	 * Changes the value associated to the given dataItem to the specified new
	 * value. Throws an InvalidDataItemException if no object of the list stores the
	 * given dataItem.
	 * 
	...
	/**
	 * Returns the value of the given dataItem. Throws an InvalidDataItemException
	 * if no CellData object of the ordered list stores the given dataItem. This
